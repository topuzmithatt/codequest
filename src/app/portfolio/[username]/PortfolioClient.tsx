    ...
    return (
      ...
      {showTour && (
        <>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 pointer-events-auto bg-[#1e1e1e] border border-teal-500 text-white p-6 rounded-lg shadow-2xl z-50" style={{ position: "fixed" }}>
