...
function PortfolioModal({
  ...
  return (
    ...
    >
      <div style={{ background: "#252526", border: "1px solid #3c3c3c", borderRadius: 8, padding: 24, width: 320, fontFamily: "'JetBrains Mono', monospace" }}>
    ...
    <VSCodeLayout userId={userId} tabs={tabs} hearts={hearts} xp={xp} level={level} streak={streak} username={username}>
      ...
      {showSandboxTour && (
        <>
          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 pointer-events-auto bg-[#1e1e1e] border border-amber-500 text-white p-6 rounded-lg shadow-2xl z-50">
