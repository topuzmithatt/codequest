...
export function ProfileTour() {
  ...
  return (
    <>
      ...
      <div className={`fixed bottom-8 right-8 w-80 pointer-events-auto bg-[#1e1e1e] border ${TOOLTIP_COLORS[current.color].split(" ")[0]} text-white p-5 rounded-lg shadow-2xl z-50`}>
