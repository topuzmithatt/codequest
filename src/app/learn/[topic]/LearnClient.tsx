...
export function LearnClient({
  ...
  return (
    ...
    >
      <div className="flex h-full overflow-hidden relative">
        ...
        {showFinishedModal && (
          <>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] pointer-events-auto bg-[#1e1e1e] border border-green-500 text-white p-8 rounded-lg shadow-2xl z-50 flex flex-col items-center">
        ...
        <div className={`relative ${tourStep === 1 ? 'z-50 ring-4 ring-blue-500 rounded-lg shadow-[0_0_30px_rgba(59,130,246,0.5)]' : ''}`}>
          <ChallengePanel
            challenge={challenge}
          ...
          />
          {tourStep === 1 && (
            <div className="absolute top-[20%] left-full ml-4 w-72 pointer-events-auto bg-[#1e1e1e] border border-blue-500 text-white p-5 rounded-lg shadow-2xl z-50">
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          <div className={`flex-1 overflow-hidden relative ${tourStep === 2 ? 'z-50 ring-4 ring-green-500 rounded-lg shadow-[0_0_30px_rgba(34,197,94,0.5)]' : ''}`}>
            <EditorPanel
              challenge={challenge}
            ...
            />
            {tourStep === 2 && (
              <div className="absolute top-[30%] left-1/2 -translate-x-1/2 w-80 pointer-events-auto bg-[#1e1e1e] border border-green-500 text-white p-5 rounded-lg shadow-2xl z-50">
          ...
          <div className={`relative ${tourStep === 3 ? 'z-50 ring-4 ring-purple-500 rounded-lg shadow-[0_0_30px_rgba(168,85,247,0.5)]' : ''}`}>
            <TerminalPanel
            ...
            />
            {tourStep === 3 && (
              <div className="absolute bottom-[110%] right-[10%] w-80 pointer-events-auto bg-[#1e1e1e] border border-purple-500 text-white p-5 rounded-lg shadow-2xl z-50">
      ...
      {tourStep === 4 && (
        <div className="fixed top-[90px] left-16 w-72 pointer-events-auto bg-[#1e1e1e] border border-orange-500 text-white p-4 rounded-lg shadow-2xl z-50">
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full text-white flex items-center justify-center shadow-lg hover:scale-110 transition-transform ${aiUsed >= MAX_AI_HINTS ? 'bg-gray-600 opacity-60' : 'bg-gradient-to-br from-violet-600 to-indigo-600'}`}
      ...
      {/* AI İpucu Paneli */}
      {aiOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-[360px] bg-[#1e1e1e] border border-violet-500/50 rounded-lg shadow-2xl overflow-hidden">
